...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    <xsl:variable name="totalProductos" select="count($XMLTienda//disco[@especial='SI'])"/>
        ...
        <html lang="es">
            ...
            <body>
                ...
                <section id="main">
                    <div class="inner">
                        <header>
                            <h1>Special Editions (50% discount)</h1>
                        </header>
                                ...
                                <tbody>
                                    <xsl:for-each select="$XMLTienda//disco[@especial='SI']">
                                        <tr>
                                            ...
                                            <td><xsl:value-of select="precio + (precio * //informacion_tienda/iva div 100) - (precio * //informacion_tienda/descuento_especial div 100)"/>€</td>
                                        </tr>
                                    </xsl:for-each>
                                </tbody>
                                <tfoot>
